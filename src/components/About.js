        ...
        <div className="about-section">
            <Container fluid>
                ...
                <Row className="justify-content-center align-items-center py-4">
                    <Col xs={10}> 
                        <h2 className="mt-5 mb-2 text-center fw-semibold">Meet Eunice Schwaab </h2>
                        <h3 className='mb-5 text-center'>Unveiling the Creative Mind</h3>
                        <Row className="about-container p-3 p-sm-4 align-items-center">
                            <Col md={8} lg={6} xxl={6} className='p-3 my-3 text-center'>
                                <Image src="./assets/eunice-about.jpg" alt="Selfie of Eunice Schwaab" className='about-img mb-4'/>
                            </Col>
                            <Col  md={8} lg={6} xxl={6} className='p-3 my-3'>
